...
* [SatoshiMacro Model (SMM)](https://satoshimacro.com/tools/crypto/satoshimacro-model/) - Free 48-signal Bitcoin cycle confluence model. Aggregates six weighted tiers (cycle timing, valuation, sentiment, rotation, miner, macro) including MVRV Z-Score, Mayer Multiple, Pi Cycle Top, Puell Multiple, and ETF flows into a single 0-100 cycle-position score with five zone classifications. Methodology fully disclosed, calibrated against historical cycle tops and bottoms.
