...
* [bitcoiners-dca](https://github.com/jiashanlu/bitcoiners-dca) - Python DCA bot for Bitcoin: multi-exchange (OKX, BitOasis, Binance UAE), maker-mode execution, buy-the-dip overlays, UAE-format tax CSV export. Docker-ready, self-hosted.
