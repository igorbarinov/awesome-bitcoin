...
* [Coldcard Risk Checker](https://bitcoinerreviews.com/coldcard) - Client-side checker for the 2026 COLDCARD seed-entropy vulnerability. Takes device model, firmware version and dice-roll entropy, never a seed phrase, and returns affected status plus migration steps.
