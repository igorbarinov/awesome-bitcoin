...
* [Satoshi API](https://bitcoinsapi.com) - AI-native Bitcoin REST API with fee intelligence, MCP integration, and self-hosting support. [GitHub](https://github.com/Bortlesboat/bitcoin-api)
