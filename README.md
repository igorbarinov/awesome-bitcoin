...
- [guardian-agent-prompts](https://github.com/milkomida77/guardian-agent-prompts) - 49 production-tested AI agent system prompts for blockchain development workflow orchestration, automated crypto tooling, and multi-agent coordination. MIT licensed.
