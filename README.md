...
* [Satoshi API](https://github.com/Bortlesboat/bitcoin-api) - Self-hosted REST API for Bitcoin Core with 40+ endpoints, tiered auth, and MCP integration for AI agents. ([Live](https://bitcoinsapi.com))
